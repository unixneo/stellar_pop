class SynthesisRunsController < ApplicationController
  ...
  def new
    ...
    @permit_celestial_coordinate_searches = permit_celestial_coordinate_searches?
  ...
  def create
    ...
    manual_sdss_coordinates = permit_celestial_coordinate_searches? && ActiveModel::Type::Boolean.new.cast(params[:manual_sdss_coordinates])
    ...
    if @synthesis_run.galaxy_id.nil? && fetch_sdss
      matched = find_catalog_target_by_coordinates(@synthesis_run.sdss_ra, @synthesis_run.sdss_dec)
  ...
  def permit_celestial_coordinate_searches?
    ActiveModel::Type::Boolean.new.cast(
      PipelineConfig.current.settings["synthesis_permit_celestial_coordinate_searches"]
    )
  end
